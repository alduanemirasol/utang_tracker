...
- Data refresh is push-based: after writes call `invalidateBusinessData(ref)` from `lib/app/coordination.dart` — NOT Drift reactive streams. Register new list/detail providers there.
