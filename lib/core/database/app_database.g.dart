...
class CustomerRow extends DataClass implements Insertable<CustomerRow> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, name, phone, notes, createdAt, updatedAt, deletedAt);
  @override
...
class $DebtItemsTable extends DebtItems
    with TableInfo<$DebtItemsTable, DebtItemRow> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<DebtItemRow> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  DebtItemRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return DebtItemRow(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
...
class DebtItemRow extends DataClass implements Insertable<DebtItemRow> {
  final String id;
  final String debtId;
  ...
  DebtItemRow copyWithCompanion(DebtItemsCompanion data) {
    return DebtItemRow(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('DebtItemRow(')
          ..write('id: $id, ')
          ..write('debtId: $debtId, ')
  ...
  @override
  int get hashCode =>
      Object.hash(id, debtId, productName, quantity, unit, price, deletedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is DebtItemRow &&
          other.id == this.id &&
...
class DebtItemsCompanion extends UpdateCompanion<DebtItemRow> {
  final Value<String> id;
  ...
  DebtItemsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       quantity = Value(quantity),
       price = Value(price);
  static Insertable<DebtItemRow> custom({
    Expression<String>? id,
...
final class $$DebtsTableReferences
  ...
  static MultiTypedResultKey<$DebtItemsTable, List<DebtItemRow>>
  _debtItemsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.debtItems,
    aliasName: 'debts__id__debt_items__debt_id',
  );

  $$DebtItemsTableProcessedTableManager get debtItemsRefs {
    final manager = $$DebtItemsTableTableManager(
      $_db,
      $_db.debtItems,
    ).filter((f) => f.debtId.id.sqlEquals($_itemColumn<String>('id')!));

    final cache = $_typedResult.readTableOrNull(_debtItemsRefsTable($_db));
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
  }
...
class $$DebtsTableFilterComposer extends Composer<_$AppDatabase, $DebtsTable> {
  ...
  Expression<bool> debtItemsRefs(
    Expression<bool> Function($$DebtItemsTableFilterComposer f) f,
  ) {
    final $$DebtItemsTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.debtItems,
...
class $$DebtsTableAnnotationComposer
  ...
  Expression<T> debtItemsRefs<T extends Object>(
    Expression<T> Function($$DebtItemsTableAnnotationComposer a) f,
  ) {
    final $$DebtItemsTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.debtItems,
      getReferencedColumn: (t) => t.debtId,
...
final class $$DebtItemsTableReferences
    extends BaseReferences<_$AppDatabase, $DebtItemsTable, DebtItemRow> {
  $$DebtItemsTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static $DebtsTable _debtIdTable(_$AppDatabase db) =>
      db.debts.createAlias('debt_items__debt_id__debts__id');
...
class $$DebtItemsTableFilterComposer
    extends Composer<_$AppDatabase, $DebtItemsTable> {
  $$DebtItemsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$DebtItemsTableTableManager
    extends
        RootTableManager<
          ...
          (DebtItemRow, $$DebtItemsTableReferences),
          DebtItemRow,
          PrefetchHooks Function({bool debtId})
        > {
  $$DebtItemsTableTableManager(_$AppDatabase db, $DebtItemsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$DebtItemsTableReferences(db, table, e),
                ),
              )
              .toList(),
                    ...
                    if (debtId) {
                      state =
                          state.withJoin(
                                ...
                                referencedTable: $$DebtItemsTableReferences
                                    ._debtIdTable(db),
                                referencedColumn: $$DebtItemsTableReferences
                                    ._debtIdTable(db)
                                    .id,
                              )
                              as T;
