...
class BackupQueueEntry extends Equatable {
  ...
  factory BackupQueueEntry.fromJson(Map<String, dynamic> json) => BackupQueueEntry(
  ...
  @override
  List<Object?> get props => [type, timestamp, retryCount];
}
